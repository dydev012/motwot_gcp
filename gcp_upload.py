...
class GCPUploader(ENV):
    ...
    def _load_to_table(self, file_path, table_ref, write_disposition, limit=None, time_partitioning=None):
    ...
    def create_table(self, file_path, limit=None):
        ...
        print(f"Created {self.main_table_ref} with {job.output_rows} rows (partitioned daily on lastMotTestDate).")
